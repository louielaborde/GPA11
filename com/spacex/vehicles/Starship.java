...
public class Starship 
{
    ...
    public void addAstronaut(String name, 
                double heightCm, double weightKg, Period stayPeriod) 
    {
        LocalDateTime arrivalDate = LocalDateTime.now();
        LocalDate departureDate = arrivalDate.toLocalDate().plus(stayPeriod);
        astronauts.add(new Astronaut(name, heightCm, weightKg, arrivalDate, 
